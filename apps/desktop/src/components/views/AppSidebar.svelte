...
<div class="sidebar" use:focusable>
	<div class="project-level">
		<div class="project-actions">
			...
			<div>
				...
				{/if}
				<Button
					testId={TestId.NavigationHistoryButton}
					kind="outline"
			...
			<div>
				...
				{/if}
				<Button
					testId={TestId.NavigationWorkTreesButton}
					kind="outline"
					icon="split"
					onclick={() => goto(workTreesPath(projectId))}
					width={34}
					class={["btn-square", isWorkTreesPath() && "btn-active"]}
					hotkey="⌘4"
					tooltip="Work Trees"
					{disabled}
				/>
	...
	<div class="global-level">
		...
		<div>
			...
			{/if}
			<Button
				testId={TestId.NavigationOverviewButton}
				kind="outline"
				icon="repo"
				onclick={() => goto(overviewPath(projectId))}
				width={34}
				class={["btn-square", isOverviewPath() && "btn-active"]}
				hotkey="⌘5"
				tooltip="Overview"
				{disabled}
			/>
		...
		<Button
			testId={TestId.NavigationGlobalSettingsButton}
			icon="settings"
			kind="outline"
		...
		/>
		<Button
			testId={TestId.NavigationShareFeedbackButton}
			icon="mail"
			kind="outline"
			tooltip="Share Feedback"
			width={34}
			class="btn-square"
			onclick={() => shareIssueModal?.show()}
		/>
	</div>
</div>
